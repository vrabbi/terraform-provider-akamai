...
page_title: "akamai_cloudlets_audience_segmentation_match_rule Data Source - terraform-provider-akamai"
subcategory: ""
description: |-
  
---

# akamai_cloudlets_audience_segmentation_match_rule (Data Source)
...
- `path_and_qs` (String) If a value is provided and match conditions are met, this property defines the path/resource/query string to rewrite URL for the incoming request.
...
- `type` (String) The array type, which can be one of the following: object or simple or range. Use the simple option when adding only an array of string-based values

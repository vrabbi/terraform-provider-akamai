...
page_title: "akamai_cloudlets_phased_release_match_rule Data Source - terraform-provider-akamai"
subcategory: ""
description: |-
  
---

# akamai_cloudlets_phased_release_match_rule (Data Source)
...
- `type` (String) The type of Cloudlet the rule is for. It is known as Continuous Deployment (CD) too.
...
- `percent` (Number) The percent of traffic that is sent to the data center.
